...
@NgModule({
  ...
  providers: [UserService, CategorieServiceService, CartserviceService, AuthentificationService, PanierService, CheckoutService, SubcategoryService,ProductService],
