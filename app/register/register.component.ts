  ...
  constructor(
    ...
    ngOnInit() {
      ...
      this.registerForm =  new FormGroup({
        nom_et_prenom: new FormControl ('', [Validators.required]),
...
onSubmit() {
  ...
  formData.append('nom_et_prenom', this.nom_et_prenom)
  ...
  formData.append('situation_familiale', this.situation_familiale)
