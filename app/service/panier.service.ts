...
export class PanierService {
  ...
  logCartData(totalPriceValue: number, totalQuantityValue: number, withLivraison: number) {
    ...
    for(let tempCartItem of this.cartItems){
      ...
      console.log(`Name: ${tempCartItem.name}, quantity: ${tempCartItem.quantity}, prix_de_vente: ${tempCartItem.prix_de_vente}, subTotalPrice: ${subTotalPrice} `);
...
addToCart(theCartItem: CartItem){
  ...
  computeCartTotals() {
    ...
    for(let tempCartItem of this.cartItems){
      totalPriceValue += tempCartItem.quantity * tempCartItem.prix_de_vente;
